      ...
      const syncConnector = () => {
        ...
        topPath.setAttribute(
          ...
          [
            ...
            `V ${topBridge - r}`,
            `A ${r} ${r} 0 0 0 ${beforeInner + r} ${topBridge}`,
            `H ${afterInner - r}`,
            `A ${r} ${r} 0 0 0 ${afterInner} ${topBridge - r}`,
            `V ${topLine + r}`,
            `A ${r} ${r} 0 0 0 ${afterInner + r} ${topLine}`,
            `H ${afterOuter - r}`,
        ...
        bottomPath.setAttribute(
          ...
          [
            ...
            `V ${bottomBridge + r}`,
            `A ${r} ${r} 0 0 0 ${afterInner - r} ${bottomBridge}`,
            `H ${beforeInner + r}`,
            `A ${r} ${r} 0 0 0 ${beforeInner} ${bottomBridge + r}`,
            `V ${bottomLine - r}`,
